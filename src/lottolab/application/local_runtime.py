...
_ALLOWED_OPENAPI_OPERATIONS = {
    ...
    "/api/v1/historical-results/imports/preview": frozenset({"post"}),
    "/api/v1/historical-results/imports": frozenset({"post"}),
    "/api/v1/historical-results/imports/{run_id}": frozenset({"get"}),
