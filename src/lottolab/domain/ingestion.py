...
class IngestionOperationType(StrEnum):
    ...
    OFFICIAL_SCHEDULE_SYNC = "OFFICIAL_SCHEDULE_SYNC"
    MANUAL_FUTURE_IDENTITY_SUPPLEMENT = "MANUAL_FUTURE_IDENTITY_SUPPLEMENT"
    MANUAL_SCHEDULE_CERTIFICATE = "MANUAL_SCHEDULE_CERTIFICATE"
