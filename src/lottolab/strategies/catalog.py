...
_PRODUCTION_DESCRIPTORS = (
    ...
    StrategyDescriptor(
        ...
        provenance=(
            ...
            "number_range:1_TO_49",
            "pick_count:6",
            "pool_size:MIN_PICK_COUNT_TIMES_2_AND_NUMBER_RANGE",
            "hot_pool:CEIL_POOL_SIZE_DIV_3_TOP_FREQUENCY_DESCENDING_INTEGER_KEY_TIE_ORDER",
            "cold_pool:CEIL_POOL_SIZE_DIV_3_BOTTOM_FREQUENCY_DESCENDING_INTEGER_KEY_TIE_ORDER",
            "random_pool:REMAINING_RANGE_WITHOUT_HOT_OR_COLD_UNSEEDED_INDEX_SPLICE",
            "candidate_pool:HOT_THEN_COLD_THEN_RANDOM_NUMBERS_FINAL_NUMERIC_ASCENDING",
            "candidate_attempts:MIN_200_OR_CANDIDATE_POOL_LENGTH_TIMES_10",
            "candidate_order:STABLE_ARRAY_SORT_WITH_0_5_MINUS_MATH_RANDOM_COMPARATOR",
            "score:FREQUENCY_SUM_PLUS_PARITY_PLUS_DYNAMIC_SUM_PLUS_CONSECUTIVE_PENALTY",
            "parity_score:IDEAL_ODD_ROUNDED_PICK_COUNT_DIV_2_PLUS_OR_MINUS_10_OTHERWISE_MINUS_10",
            "sum_score:IDEAL_THEORETICAL_MIDPOINT_PLUS_OR_MINUS_40_PERCENT_RANGE_OTHERWISE_MINUS_0_1_DEVIATION",
            "consecutive_penalty:ADJACENT_DIFFERENCE_ONE_COUNT_GREATER_THAN_PICK_COUNT_DIV_2_MINUS_20",
            "score_tie:STRICT_GREATER_FIRST_SAMPLE_WINS",
            "coverage_semantics:SINGLE_TICKET_HEURISTIC_WITH_NO_MULTI_TICKET_GUARANTEE",
            "ticket_order:FINAL_NUMERIC_ASCENDING",
            "portfolio_cardinality:EXACTLY_1_SINGLE_TICKET",
            "minimum_history:TARGET_BOUNDARY_1_SOURCE_ACCEPTS_EMPTY",
            "source_empty_behavior:INITIALIZED_ZERO_FREQUENCY_HOT_1_TO_4_COLD_46_TO_49",
            "target_empty_behavior:INSUFFICIENT_HISTORY",
            "fallback:NO_BEST_COMBINATION_UNDER_RESOLVED_BIG_LOTTO_RULES",
            "randomness:PROCESS_GLOBAL_UNSEEDED_MATH_RANDOM_EQUIVALENT",
            "rng_boundary:EXPLICIT_ADAPTER_CONSTRUCTOR_RANDOM_SOURCE_FOR_PARITY_ONLY",
            "donor_execution:EXECUTABLE_DIRECT_NODE_MODULE_IMPORT_WITH_SYNCHRONOUS_STATISTICS_SERVICE_STUB_AND_FIXED_RANDOM_SEQUENCE",
            "runtime_boundary:CALLER_SUPPLIED_CAUSAL_HISTORY_NO_DB",
            ...
            "db_write:NONE",
            "predictive_advantage_claimed:NO",
            "migration_task:LANE3_WHEELING_LEGACY_METHOD_MIGRATION_R15",
        ),
        response_shape=ResponseShape.SINGLE_TICKET,
        native_ticket_count=1,
    ),
    StrategyDescriptor(
        strategy_id="legacy_biglotto__frontend_unified_ensemble_weighted__8f1183a9d8a7",
        ...
        provenance=(
            ...
            "legacy_history_order:NEWEST_FIRST",
            "target_history_order:OLDEST_FIRST_REVERSED_AT_ADAPTER_BOUNDARY",
            "architecture:ENSEMBLE_LOCAL_FROZEN_SCORING_PORT",
            "leaf_ports:FREQUENCY_TREND_MARKOV_MONTECARLO_DEVIATION",
            "leaf_weights:1.2_1.2_1.3_1.2_1.3",
            "truthy_probability_skip:YES",
            ...
            "randomness:PROCESS_GLOBAL_UNSEEDED_MATH_RANDOM_EQUIVALENT",
            "rng_boundary:EXPLICIT_ADAPTER_CONSTRUCTOR_RANDOM_SOURCE_FOR_PARITY_ONLY",
            "rng_call_order:FREQUENCY_TREND_MARKOV_THEN_MONTECARLO_THEN_DEVIATION",
            "donor_execution:EXECUTABLE_DIRECT_NODE_MODULE_IMPORT_WITH_SYNCHRONOUS_STATISTICS_SERVICE_STUB_AND_FIXED_RANDOM_SEQUENCE",
            "runtime_boundary:CALLER_SUPPLIED_CAUSAL_HISTORY_NO_DB",
            "live_db_required:NO",
            "db_write:NONE",
    ...
    StrategyDescriptor(
        strategy_id="legacy_biglotto__frontend_unified_ensemble_combined__8f1183a9d8a7",
        ...
        provenance=(
            ...
            "target_history_order:OLDEST_FIRST_REVERSED_AT_ADAPTER_BOUNDARY",
            "architecture:ENSEMBLE_LOCAL_FROZEN_SCORING_PORT",
            "tail_weight:ASSIGNED_0.15_NEVER_APPLIED",
            "legacy_response_shape:NUMBERS_PROBABILITIES_CONFIDENCE_METHOD_REPORT",
            "number_range:1_TO_49",
            "pick_count:6",
            "ranking:DESCENDING_PROBABILITY_ASCENDING_INTEGER_KEY_TIE_ORDER",
            ...
            "target_empty_behavior:INSUFFICIENT_HISTORY",
            "randomness:NONE_DETERMINISTIC",
            "donor_execution:EXECUTABLE_DIRECT_NODE_MODULE_IMPORT_WITH_SYNCHRONOUS_STATISTICS_SERVICE_STUB",
            "runtime_boundary:CALLER_SUPPLIED_CAUSAL_HISTORY_NO_DB",
            "live_db_required:NO",
            "db_write:NONE",
            "predictive_advantage_claimed:NO",
    ...
    StrategyDescriptor(
        strategy_id="legacy_biglotto__frontend_unified_ensemble_advanced__8f1183a9d8a7",
        ...
        provenance=(
            ...
            "legacy_mode_dispatch:DEFAULT_PREDICT_WEIGHTED",
            "legacy_lottery:src/utils/Constants.js:LOTTERY_RULES",
            "legacy_history_order:NEWEST_FIRST",
            "target_history_order:OLDEST_FIRST_REVERSED_AT_ADAPTER_BOUNDARY",
            "architecture:ENSEMBLE_LOCAL_FROZEN_SCORING_PORT",
    ...
    StrategyDescriptor(
        strategy_id="legacy_biglotto__frontend_collaborative_hybrid__97d79db161ba",
        ...
        min_history=1,
        provenance=(
            "legacy_source:src/engine/strategies/CollaborativeStrategy.js",
            "legacy_source_sha256:"
            "97d79db161bac5d83aa3c6f4738f33bad1183056fe26dc1dba593fdcb35447db",
            "legacy_symbol:CollaborativeStrategy.predict",
            "legacy_runtime:PredictionEngine.strategies.collaborative_hybrid",
            "legacy_quick_prediction:BIG_LOTTO_TO_collaborative_hybrid",
            "legacy_alias_remap:collaborative_relay_TO_collaborative_hybrid",
            "legacy_alias_remap:collaborative_coop_TO_collaborative_hybrid",
            "legacy_mode:hybrid",
            "legacy_mode_dispatch:relay_cooperative_hybrid_DEFAULT_hybrid",
            "legacy_lottery:src/utils/Constants.js:LOTTERY_RULES",
            "legacy_history_order:NEWEST_FIRST",
            "target_history_order:OLDEST_FIRST_REVERSED_AT_ADAPTER_BOUNDARY",
            "history_consumed:IDENTICAL_FULL_HISTORY_TO_ALL_EXPERTS",
            "expert_order:"
            "FREQUENCY_TREND_COMBINED_BAYESIAN_DEVIATION_MONTECARLO_"
            "MARKOV_COOCCURRENCE_FEATUREWEIGHTED_RANDOMFOREST_GENETIC",
            "expert_weights:1.0_1.2_1.5_1.3_1.2_1.4_1.3_1.1_1.4_1.5_1.6",
            "architecture:COLLABORATIVE_LOCAL_FROZEN_SCORING_PORT",
            "protected_adapters:LEAF_R16_UNIFIED_ENSEMBLE_R17_ML_UNCHANGED",
            "stages:EXPLORATION_TOP25_REFINEMENT_TOP15_DECISION_TOP6",
            "voting:PROBABILITY_WEIGHT_CONFIDENCE_PLUS_ASCENDING_TICKET_RANK",
            "constraints:ODD_EVEN_THEN_ZONE_COVERAGE_THEN_SUM_RANGE",
            "legacy_response_shape:NUMBERS_PROBABILITIES_CONFIDENCE_METHOD_REPORT",
            "load_bearing_child_metadata:PROBABILITIES_AND_CONFIDENCE",
            "non_load_bearing_child_metadata:METHOD_AND_REPORT",
            "number_range:1_TO_49",
            "pick_count:6",
            "ranking:DESCENDING_SCORE_ASCENDING_INTEGER_KEY_TIE_ORDER",
            "ticket_order:FINAL_NUMERIC_ASCENDING",
            "portfolio_cardinality:EXACTLY_1_SINGLE_TICKET",
            "minimum_history:TARGET_AND_PREDICTION_ENGINE_BOUNDARY_1",
            "target_empty_behavior:INSUFFICIENT_HISTORY",
            "expert_error_behavior:LOG_AND_OMIT_FAILED_EXPERT_THEN_CONTINUE",
            "randomness:PROCESS_GLOBAL_UNSEEDED_MATH_RANDOM_EQUIVALENT",
            "rng_sharing:ONE_GLOBAL_STREAM_ACROSS_MONTECARLO_RANDOMFOREST_GENETIC",
            "rng_boundary:EXPLICIT_ADAPTER_CONSTRUCTOR_RANDOM_SOURCE_FOR_PARITY_ONLY",
            "seed_semantics:GENERATE_REQUEST_SEED_NOT_THREADED",
            "donor_execution:"
            "REVIVED_DIRECT_NODE_WITH_SYNCHRONOUS_STATISTICS_AND_BROWSER_REGISTRY_SEAMS",
            "runtime_boundary:CALLER_SUPPLIED_CAUSAL_HISTORY_NO_DB",
            "live_db_required:NO",
            "db_write:NONE",
            "predictive_advantage_claimed:NO",
            "migration_task:LANE3_COLLABORATIVE_STRATEGY_LEGACY_METHOD_MIGRATION_R18",
        ),
        response_shape=ResponseShape.SINGLE_TICKET,
        native_ticket_count=1,
    ),
