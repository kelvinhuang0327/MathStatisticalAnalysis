...
COLD_HUNTER_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    100: (2, 8, 13, 14, 15, 25),
    150: (3, 9, 14, 15, 16, 26),
    151: (4, 10, 15, 16, 17, 27),
    200: (4, 10, 15, 16, 17, 27),
    300: (1, 6, 12, 18, 19, 29),
    500: (5, 10, 16, 22, 23, 33),
...
SHORT_WINDOW_DEVIATION_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    2: (3, 4, 5, 6, 9, 10),
    5: (6, 17, 18, 19, 20, 21),
    10: (22, 23, 33, 34, 44, 45),
    15: (27, 28, 29, 38, 39, 49),
    19: (31, 32, 33, 42, 43, 44),
    20: (5, 6, 32, 33, 43, 44),
    21: (6, 33, 34, 35, 44, 45),
    25: (37, 38, 39, 40, 48, 49),
    30: (4, 5, 6, 42, 43, 44),
    49: (12, 13, 23, 24, 34, 35),
    50: (13, 14, 24, 25, 35, 36),
    51: (14, 15, 25, 26, 36, 37),
    55: (18, 19, 29, 30, 40, 41),
    80: (5, 6, 16, 17, 43, 44),
    100: (14, 15, 25, 26, 36, 37),
    150: (15, 16, 26, 27, 37, 38),
    151: (16, 17, 27, 28, 38, 39),
    200: (16, 17, 27, 28, 38, 39),
    300: (18, 19, 29, 30, 40, 41),
    500: (22, 23, 33, 34, 44, 45),
...
REBOUND_AWARE_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    55: (1, 19, 20, 28, 29, 30),
    80: (4, 6, 17, 26, 43, 44),
    100: (2, 15, 16, 26, 35, 36),
    150: (3, 16, 26, 27, 36, 38),
    151: (4, 17, 18, 26, 27, 28),
    200: (4, 17, 18, 26, 27, 28),
    300: (1, 19, 20, 28, 29, 30),
    500: (5, 23, 32, 33, 34, 45),
    750: (1, 2, 10, 26, 27, 28),
}
...
ZONE_MOMENTUM_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    49: (12, 13, 23, 24, 34, 35),
    80: (5, 16, 17, 19, 32, 43),
    500: (1, 11, 22, 33, 44, 45),
    750: (1, 16, 27, 28, 38, 49),
}
...
MODERATE_RANK_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    55: (4, 10, 18, 21, 29, 49),
    80: (2, 5, 8, 13, 16, 41),
    100: (6, 11, 14, 17, 25, 45),
    150: (1, 7, 15, 18, 26, 46),
    151: (2, 8, 16, 19, 27, 47),
    200: (2, 8, 16, 19, 27, 47),
    300: (4, 10, 18, 21, 29, 49),
    500: (3, 8, 22, 25, 33, 42),
    750: (3, 8, 13, 27, 38, 47),
}
...
DMS_SOLO_GOLDENS: dict[int, tuple[int, ...]] = {
    ...
    10: (1, 2, 3, 4, 5, 7),
    15: (7, 8, 9, 10, 12, 13),
    19: (11, 12, 13, 14, 16, 17),
    20: (12, 13, 14, 15, 17, 18),
    21: (13, 14, 15, 16, 18, 19),
    25: (17, 18, 19, 20, 23, 24),
    30: (23, 27, 28, 29, 30, 32),
    49: (2, 40, 46, 47, 48, 49),
    50: (1, 3, 41, 47, 48, 49),
    51: (3, 9, 14, 25, 36, 47),
    55: (2, 7, 13, 18, 29, 40),
    80: (5, 16, 27, 32, 38, 43),
    100: (3, 9, 14, 25, 36, 47),
    150: (4, 10, 15, 26, 37, 48),
    151: (5, 11, 16, 27, 38, 49),
    200: (5, 11, 16, 27, 38, 49),
    300: (2, 7, 13, 18, 29, 40),
    500: (6, 11, 17, 22, 33, 44),
...
def test_production_catalog_appends_newer_descriptors_after_batch15() -> None:
    ...
    ``acb_markov_midfreq_3bet``), the later selected intake descriptors, and
    the 9 non-overlapping legacy-mechanism batch descriptors.
    """
