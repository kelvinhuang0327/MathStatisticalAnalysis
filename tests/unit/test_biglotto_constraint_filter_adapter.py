...
def test_production_catalog_preserves_constraint_filter_append_position() -> None:
    ...
    assert all_ids[-21] == "acb_single_539"
    ...
    assert all_ids[-3] == "legacy_biglotto__power_fourier_rhythm__cb75e72e4c94"
    assert all_ids[-2] == ("legacy_biglotto__backtest_big_lotto_orthogonal_5bet__c4dff46c5a5e")
    assert all_ids[-1] == "legacy_biglotto__predict_biglotto_quad_strike__e202e664208f"
