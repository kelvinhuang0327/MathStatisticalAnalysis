...
COMMITTED_CONTRACT_JSON_FILES = (
    ...
    REPO_ROOT / "contracts/evidence/metric_definitions/m1_plus.json",
    REPO_ROOT / "contracts/evidence/metric_definitions/m2_plus.json",
    REPO_ROOT / "contracts/evidence/metric_definitions/m3_plus.json",
    REPO_ROOT / "contracts/evidence/metric_definitions/m4_plus.json",
    REPO_ROOT / "contracts/evidence/metric_definitions/avg_match.json",
