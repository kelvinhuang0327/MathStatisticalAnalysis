...
def test_all_identity_summary_uses_live_accounting_and_does_not_iterate_results(
    ...
    # SELECTED_INTAKE_SET03_R1 registered 2 more BIG_LOTTO identities as
    # executable (verify_markov_vs_triple_2bet, backtest_biglotto_coldpool_15),
    # moving them from historical_raw_only to currently_replayable: see
    # test_b649_historical_replay.py::test_b649_identity_accounting_covers_all_221_identities.
    assert summary == {
        "currently_replayable_identity_count": 54,
        "historical_raw_only_identity_count": 79,
