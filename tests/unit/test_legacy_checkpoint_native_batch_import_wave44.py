"""Causal batch contracts for wave 44."""
...
from tests.unit.test_legacy_checkpoint_native_portfolios_wave44 import (
    CONTEXT,
)
from typer.testing import CliRunner

import lottolab.infrastructure.legacy_checkpoint_native_batch_import_wave44 as batch_module
...
def test_wave44_batch_preserves_causal_checkpoint_coverage(
    monkeypatch: Any,
) -> None:
    def fake_load(
        *,
    ...
    document = (
        batch_module.materialize_legacy_checkpoint_native_wave44_batch(
...
def test_wave44_cli_is_registered() -> None:
