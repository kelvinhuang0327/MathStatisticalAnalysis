"""Lock the Phase-7 T539 next-generation constructor replication parameters.

Must run before any native T539 candidate portfolio coverage inspection.
The run tool re-hashes `LOCKED_PARAMETERS` and refuses to execute if this
file has been edited after lock. B649 is referenced as sealed authority
only and is not rerun.
"""
...
SIDON_RESULT = MATRIX_RESULTS + "diversification-coverage-t539-v1-result.json"
ARM_B_RESULT = MATRIX_RESULTS + "greedy-min-overlap-constructor-t539-v1-result.json"
...
LOCKED_PARAMETERS: dict[str, Any] = {
    ...
    "arm_c_role": "not_applicable_no_t539_frontier",
    ...
    "design_file_blobs": [
        ...
        {
            "blob": "f6b95bed2e0d51ed81781efd096d4f87d88606a1",
            "path": "src/lottolab/research/cyclic_sidon_shift_t539.py",
        },
        {
        ...
        {
            "blob": "372542aa0c164d3548a6aaa91dd56b28821d0eaa",
            "path": "src/lottolab/research/greedy_min_overlap_constructor_t539.py",
        },
    ],
    "draw_size": 5,
    ...
    "fail_classification": "DO_NOT_ADVANCE_THIS_EXACT_T539_REPLICATION",
    "geometry_metrics": [
        "max_pairwise_overlap",
    ...
    "monte_carlo": False,
    "owner_authorization": "AUTHORIZE_MATRIX_PHASE7_T539_NEXT_GEN_CONSTRUCTOR_REPLICATION_R1",
    "p638_execution": "not_run",
    "parameter_rescue": "forbidden",
    "pass_classification": "T539_NEXT_GEN_CONSTRUCTOR_REPLICATION_SUPPORTED",
    "pool_size": 39,
    ...
    "sealed_q_d": [
        ...
        (
            "210136421818019142830254085117764470705343"
            "/2189141756352303974883307976771119210042635"
        ),
        (
            "4425648389458544938963379911506957588946026049013937458614804247"
            "/31505246626552976138504202934751941466931572184558599814136269720"
        ),
        (
            "1715441071920970397176193765176714544329158433866151866864960526518171695862708197"
            "/9385896987682404793826377339653018372590533675528860392291054310717822221458647480"
        ),
    ],
