"""Write the single attempt-ledger record after the locked P638 Zone-1 result exists."""
...
OUTPUT_PATH = Path(
    "docs/research/matrix-native-results/"
    "constructor-frontier-next-generation-p638-zone1-v1-attempt-ledger.json"
)
...
def main() -> None:
    ...
    entry: dict[str, Any] = {
        "attempt_id": (
            "STRATEGY_MATRIX_PHASE7_P638_ZONE1_NEXT_GEN_CONSTRUCTOR_REPLICATION_V1__ATTEMPT_1"
        ),
        "design_version": "V1",
