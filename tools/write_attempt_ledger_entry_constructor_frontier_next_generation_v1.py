"""Write the single attempt-ledger record after the locked result exists."""
...
OUTPUT_PATH = Path(
    ...
    "constructor-frontier-next-generation-v1-attempt-ledger.json"
)
...
def main() -> None:
    ...
    entry: dict[str, Any] = {
        "attempt_id": "STRATEGY_MATRIX_PHASE7_CONSTRUCTOR_FRONTIER_NEXT_GENERATION_V1__ATTEMPT_1",
        "design_version": "V1",
