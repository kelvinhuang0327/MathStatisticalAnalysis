"""Write the single attempt-ledger record for the T539 diversification experiment.

Mirrors `write_attempt_ledger_entry.py` (B649) exactly. `result_hash_sha256`
...
OUTPUT_PATH = Path(
    "docs/research/matrix-native-results/diversification-coverage-t539-v1-attempt-ledger.json"
)
...
def main() -> None:
    ...
    entry: dict[str, Any] = {
        "attempt_id": "DIVERSIFICATION_COVERAGE_T539_V1__ATTEMPT_1",
        "sequence": 1,
        "task_id": "STRATEGY_MATRIX_PHASE2_T539_DIVERSIFICATION_COVERAGE_R1",
